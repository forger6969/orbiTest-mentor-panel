...
import { FeaturedCardProgressBar } from "./application/app-navigation/base-components/FeaturedCardProgress";
import type { NavItemType } from "@/components/application/app-navigation/config";
import { SidebarNavigationSimple } from "./application/app-navigation/base-components/SidebarNavigationSimple";
