...
const AuthPage = () => {
  ...
  // ✅ GOOGLE AUTH ДЛЯ МЕНТОРОВ
  const handleGoogleLogin = () => {
    window.location.href = `${import.meta.env.VITE_BACKEND_API}/api/mentor/google/mentor`;
  };
      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-center px-4 gap-6">
        ...
        <div className="bg-white rounded-2xl max-w-3xl w-full p-6 md:p-8 shadow-2xl relative">
          ...
          <button
            ...
            disabled={isLoader}
            className="
              w-full mb-6 py-3 px-4 rounded-lg
          ...
          <form className="flex flex-col gap-4">
            <div className="flex flex-col gap-1">
              ...
              <input
                ...
                disabled={isLoader}
                className="rounded-lg border border-gray-300 px-4 py-2 text-gray-900 outline-none transition focus:border-black focus:ring-1 focus:ring-black disabled:opacity-50 disabled:cursor-not-allowed"
              />
            </div>
